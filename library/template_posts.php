<?php
	...
	if(VPRO && (is_page_template('page-feature.php') || is_page_template('page-feature-page.php') || (is_home() && lebenswelt('featureblog')))) $featureslide_template = true;
	else $featureslide_template = false;
	
	if(VPRO && (is_page_template('page-feature.php') || m_lebenswelt('featureboxes', $lebenswelt_ID))) $fboxes_template = true;
...
<div id="contentcontainer" class="grad1 container fix <?php if(m_lebenswelt('sidebar_layout', $post->ID) == 'left') echo 'sidebar_left';?>"> 
