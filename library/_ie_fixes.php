...
<?php endif;?>
<!--[if IE 7]>
	<link rel="stylesheet" href="<?php echo THEME_CSS.'/ie7.css';?>" type="text/css" media="screen" />
	
	<script type="text/javascript" src="<?php echo THEME_JS; ?>/dropdown_ie7.js"></script>
<![endif]-->
