	...
	return array(
		'feature_settings' => array(
					...
					'feature_playpause' => array(
							...
							'shortexp' => "Show a play/pause button for auto-scrolling features (Timeout must be greater than 0)",
							'exp' => "Selecting this option will add a play/pause button for auto-scrolling features, that users can use to pause and watch a video, read a feature, etc..<br/><br/>For this to work, timeout must be set."
						),
...
function get_default_features(){
	return array(
			...
			'2' => array(
		        	...
		        	'text' => '<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aliquam quis molestie nunc. Vivamus molestie, quam vitae pharetra  at ultricies tortor quam sed ante.</p>',
		        	'media' => '<object width="'.FMEDIAWIDTH.'" height="'.FMEDIAHEIGHT.'"><param value="transparent" name="wmode" /><param name="movie" value="http://www.youtube.com/v/Kza-iTe2100&hl=en&fs=1&showinfo=0"></param><param name="allowFullScreen" value="true"></param><param name="allowscriptaccess" value="always"></param><embed src="http://www.youtube.com/v/Kza-iTe2100&hl=en&fs=1&showinfo=0" type="application/x-shockwave-flash" allowscriptaccess="always"  wmode="transparent" allowfullscreen="true" width="'.FMEDIAWIDTH.'" height="'.FMEDIAHEIGHT.'"></embed></object>',
		        	'link' => '#url_goes_here',
