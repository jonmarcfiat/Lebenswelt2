...
function get_option_array(){
	...
	$default_options = array(
		...
		'header_and_nav' => array(
				...
				'custom_header' => array(
					'default' => THEME_IMAGES.'/fiat-logo-header.png',
				...
				'subnav_categories' => array(
						...
						'exp' => 'This option will show category links on the posts page and categories pages. ' . 
								 'Enter category IDs seperated by commas.<br/><br/>For example, <strong>12, 8, 21</strong> ' .
				...
				'twitterlink' => array(
						...
						'exp' => 'This is the full URL not just the username.'
					),
				'linkedinlink' => array(
						'default' => '',
						'version' => 'pro',
				...
				'youtubelink' => array(
						...
						'version' => 'pro',
						'type' => 'text',
						'inputlabel' => 'Your YouTube Profile URL',
						'title' => 'YouTube Profile Link',
						'shortexp' => 'Places YouTube icon in your header',
						'exp' => ''
					) */
			),
		...
		'footer_options' => array(
				'bottom_sidebars' => array(
						...
						'default' => true,
						'type' => 'check',
						'inputlabel' => 'Show widgetized columns above footer?',
						'title' => 'Show sidebars above footer ("morefoot area")',
				...
				'footer_logo' => array(
						'version' => 'pro',
						'default' => THEME_IMAGES.'/fiat-footer-logo.png',
						'type' => 'image_url',
						'imagepreview' => '80',
		...
		/* 'text_options' => array(
				...
				'font_file' => array(
						'version' => 'pro',
						'default' => THEME_JS.'/goudy.font.js',
						'type' => 'text',
						'inputlabel' => 'Cufon replacement font file URL',
						'title' => 'Replacement Font File URL',
						'shortexp' => 'The font file used to replace text.',
						'exp' => 'Use the <a href="http://cufon.shoqolate.com/generate/">Cufon site</a> to generate a font file for use with this theme.  Place it in your theme folder and add the full URL to it here. The default font is Goudy.'
				),
				'replace_font' => array(
						'version' => 'pro',
						'default' => '.fcontent .fsub, .fcontent .ftitle',
						'type' => 'text',
						'layout' => 'full',
		...
		'global_options' => array(
				...
				'favicon' => array(
					'default' => CORE_IMAGES."/favicon.ico",
					'type' => 'image_url',
					'imagepreview' => '16',
					'title' => 'Favicon Image',						
				...
				/* 'google_ie' => array(
						...
						'exp' => 'More info on this can be found <a href="http://code.google.com/p/ie7-js/">here</a>.'
				), */			
				'touchicon' => array(
					'version' => 'pro',
					'default' => '',
		...
		$welcome = array(
				...
				'welcome' => array(
						'theme_introduction' => array(
								...
								'layout' => 'full',
								'title' => 'Thanks for using '.THEMENAME."!",
								'shortexp' => 'We mean it, <strong>thanks a ton for supporting us</strong>.',
								'exp' => '<p><img style="width: 200px; padding: 5px;background: #eee" class="alignright border" src="'.THEME_IMAGES.'/fiat-circle-logo.png" /><strong style="">About This Theme</strong></p>'.
								'<p>The team at <a href="http://fiatinsight.com">Fiat | Insight</a> has spent lots of time making this theme exceptionally beautiful and easy to use. Partnered with the ever-praised WordPress CMS, Lebenswelt is a high-performance, out-of-the-box solution for any number of web needs.<br/><small>(Note: This theme intro can be removed below.)</small></p><ul>'
							),
						'hide_introduction' => array(
								'default' => '',
								'type' => 'check',
